...
import {ListReservation} from "../ListReservationsPage/components/ListReservation";
import {Link} from "react-router-dom";
import {Pagination} from "../Utils/Pagination";
import {ListMyReservation} from "./components/ListMyReservation";
...
export const MyReservationsPage = () => {
    ...
    useEffect(() => {
        const fetchReservations = async () => {
            ...
            if (searchUrl === '') {
                url = `${baseUrl}/getMyReservations?page=${currentPage - 1}&size=${reservationsPerPage}`;
            } else {
                        ...
                        <>
                            ...
                            <table className='table table-hover'>
                                ...
                                {reservations.map(reservation => (
                                    <ListMyReservation reservation={reservation} key={reservation.reservationId}/>
                                ))}
                                </tbody>
                            </table>
                        </>
