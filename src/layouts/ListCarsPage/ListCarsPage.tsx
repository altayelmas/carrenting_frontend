...
export const ListCarsPage = () => {
    ...
    useEffect(() => {
        const fetchCars = async () => {
            ...
            if (searchUrl === '' && brandSelection === 'All') {
                url = `${baseUrl}/getAllCars?page=${currentPage - 1}&size=${carsPerPage}&carBrand=&carModel=`;
            } else {
    ...
    const searchHandleChange = () => {
        ...
        if ((brandSelection === 'Audi' ||
            ...
            setSearchUrl(`/getAllCars?page=<pageNumber>&size=${carsPerPage}&carBrand=${brandSelection}&carModel=${search}`);
            ...
            brandSelection === 'Renault' ||
            brandSelection === 'Volkswagen')) && search !== '') {
            setSearchUrl(`/getAllCars?page=<pageNumber>&size=${carsPerPage}&carBrand=&carModel=${search}`);
        } else {
            setSearchUrl('');
        }
    }
                ...
                <div>
                    ...
                    {totalAmountOfCars > 0 ?
                        <>
                            ...
                            {cars.map(car => (
                                <ListCars car={car} key={car.licencePlate}/>
                            ))}
                        </>
                        :
                        <div className='m-5'>
